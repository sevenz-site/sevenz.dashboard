// El icono de WhatsApp. Sustituye al globo de diálogo de lucide
// (`MessageCircle`) en los siete sitios donde la acción es literalmente abrir
// WhatsApp: un globo genérico decía "chat" cuando lo que pasa al tocarlo es
// salir a otra aplicación concreta.
//
// El archivo tal cual lo entregó diseño vive en `public/icons/whatsapp.svg`.
// Este componente repite su trazado porque un <img> no puede heredar el color
// del texto ni escalarse con `size-4`. SI EL TRAZADO CAMBIA, HAY QUE CAMBIARLO
// EN LOS DOS.
//
// ─────────────────────────────────────────────────────────────────────────
// DOS COSAS QUE NO SON COMO EN EL ARCHIVO, y las dos a propósito:
//
// 1. `currentColor` en vez del verde fijo `#126400` del original. Cada sitio
//    que lo usa ya fija su color y el icono ahora lo sigue: verde en
//    "Contactar vía WhatsApp", verde de marca en "Compartir saldo", y el color
//    del texto en el botón de la cabecera del cliente. Con el verde clavado,
//    en tema oscuro quedaba un verde casi negro sobre fondo casi negro — un
//    fallo de contraste en el único sitio donde nadie lo habría mirado.
//
// 2. El `viewBox` sigue siendo 21×24, que NO es cuadrado como los de lucide.
//    No se recorta ni se estira: con `size-4` la caja mide 16×16 y el dibujo
//    entra centrado a 14×16, porque `preserveAspectRatio` vale `xMidYMid meet`
//    por defecto. Forzarlo a cuadrado sí lo deformaría.
